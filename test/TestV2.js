...
describe("IDNFT V2", function () {
  it("Test IDNFT", async function () {
    ...
    console.log("grant idnft admin role");
    ...
    console.log("grant idnft controller role");
    ...
    console.log("grant controller admin role");
    ...
    console.log("grant roles to owner");
    ...
    console.log("allocate SBT points to idnft 0 and 1");
    ...
    console.log("merge idnft tokenId1 to tokenId0");
    await controller.merge(tokenId1, tokenId0);
